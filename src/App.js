      ...
      <main className="main-content">
        <section className="section">
          ...
          <p>
            ...
            end up as CO2 in our atmosphere when it breaks down, even if you compost it a lot of the C02 is still released. With Biochar we handle the
            "Storage" part of Carbon Capture and Storage. Trees
            and plants have already done the "Carbon Capture" for us through photosynthesis! We just lock up that carbon for the rest of our lives by adding it to soil and cement so it can't burn up and end up back in the air one day.  Since Carbon is inert it won't react and even if an animal eats it it still stays as carbon, just with a bunch of organic material around it.  Biochar is generated by
