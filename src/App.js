      ...
      <main className="main-content">
        <section className="section">
          ...
          <p>
            ...
            waste stream already. Ever gotten an Amazon delivery box and wish
            you dind't have to deal with it after you get your goodie
            delivered?. We can make Biochar from all of that waste and put it
            back into soils and building materials. Oh and we don't have to
            inject C02 into the core of the earth, cause that sounds like fun.
            No. Instead, we get a clean building material that can be used in a
            variety of applications, and it turns out that plants and soil love
            it too. So we can make a profit and save the planet at the same
            time. We are the future, and we are here now. Or just let AI just
            handle everything, we can micro-manage our way out of the climate
            crisis. I mean, what could go wrong? AI is amazing, it is great at
            monitoring global emissions, but as of yet AI hasn't actually
            sequestered any carbon. In fact it uses energy, and that energy is
            usually generated by burning fossil fuels. So we are going to need a
            lot of Biochar to offset that. We are the future, and we are here
            now.
          </p>
        </section>
