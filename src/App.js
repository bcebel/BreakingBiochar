      ...
      <main className="main-content">
        <section className="section">
          ...
          <p>
            ...
            end up as CO2 in our atmosphere when it breaks down. With Biochar we
            handle the "Storage" part of Carbon Capture and Storage. Trees and
            plants have already done the "Carbon Capture" for us through
            photosynthesis! We just lock up that carbon for the rest of our
            lives by adding it to soil and cement so it can't burn up and end up
            back in the air one day.{" "}
          </p>
          <p>
            Biochar is generated by heating organic matter in a low-oxygen
            environment, a process known as pyrolysis. Initially, we will focus
            on volume, diverting as much carbon waste into solid carbon as
            possible. We will utilize an 'Air Curtain' that blows air onto the
            top of the fire, this keeps the smoke from being emitted and it
            gives oxygen to the top of the fire. Creating a toasty, clean burn
            that reburns the smoke until the smoke is gone. That toasty fire is
            what is required to create the char.{" "}
          </p>
          <p>
          ...
          <p>
            ...
            and help clean up the wastestream locally. We will cross promote our
            progress as a community. Every household in America generates 5
            pounds of trash a day and half of that is organic material that
          ...
          <p>
            ...
            carbon fiber, and graphene. Biochar sequesters carbon for 100 years
            or more. Biochar also reduces landfill volume and their associated
            ...
            and released to the atmosphere. We can also generate green fuels and
            green energy from the gasses produced during the pyrolysis process.
            This is a great way to reduce our dependence on fossil fuels and
            reduce our carbon footprint. Biochar is a sustainable and
            cost-effective solution for carbon capture and storage.
          </p>
          <h2>Costs</h2>
          <p>
