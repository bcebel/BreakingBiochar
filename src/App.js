      ...
      <main className="main-content">
        <section className="section">
          ...
          <p>
            ...
            carbon waste into solid carbon as possible. We will source carbon
            from the City of Austin TX using public and private sources for
          ...
          <p>
            ...
            carbon footprint, yet global emissions continue to rise. We have
            been promised carbon capture and storage technologies that are still
            not viable. We have been promised green fuels that are still not
            available. We have been promised green building materials that are
            still not affordable. We have been promised a green economy that is
            still not here. We have been promised a sustainable future that is
            still not within reach. We have been promised a better world for our
            children that is still not guaranteed. We have been promised a
            solution to climate change that is still not in sight. We have been
            promised a future that is still uncertain. We are Breaking Biochar.
            We are the future, and we are here now. Right now. It's your
            tomorrow.
          </p>
          <h2>About Us</h2>
          <p>
